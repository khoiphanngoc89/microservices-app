...
/// query does not have as normal. <see cref="MediatR.IPipelineBehavior{TRequest, TResponse}"> work like middleware
/// </summary>
...
/// see back <see cref="BuildingBlocks.Cores.ICommand"/>
/// </marks>
